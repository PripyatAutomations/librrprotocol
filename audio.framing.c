...
size_t pack_audio_frame(uint8_t *out, uint16_t chan_id, uint16_t seq, const void *data,
                        size_t len) {
...
void unpack_audio_frame(const uint8_t *in, uint16_t *chan_id, uint16_t *seq,
